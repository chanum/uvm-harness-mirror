...
`ifndef __i2c_seq_item__
`define __i2c_seq_item__
...
class i2c_seq_item extends uvm_sequence_item;
  ...
  //rand i2c_ad_hoc_policy_list#(i2c_seq_item) ad_hoc_plist;
  //rand i2c_policy_list#(i2c_seq_item) seq_plist;
  //rand i2c_policy_list#(i2c_seq_item) seqr_plist;
  ...
  //  super.pre_randomize();
  //  if (cfg == null) begin
  //    if (! uvm_config_db#(i2c_vip_cfg)::get(p_sequencer, get_name(), "cfg", cfg)) begin
  //      cfg = p_sequencer.cfg;
  //    end
  //  end
  ...
  //    end
  //  end
  //  if (uvm_config_db#(i2c_policy_list#(i2c_seq_item))::get(null, get_full_name(), "policy_list", seq_plist)) begin
  //    seq_plist.set_item(this);
  //  end
  //  if (uvm_config_db#(i2c_policy_list#(i2c_seq_item))::get(p_sequencer, get_name(), "policy_list", seqr_plist)) begin
