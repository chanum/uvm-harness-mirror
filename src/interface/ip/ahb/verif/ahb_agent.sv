...
`ifndef __ahb_agent__
`define __ahb_agent__
...
class ahb_agent extends uvm_agent;
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    monitor = ahb_monitor::type_id::create("monitor", this); monitor.cfg = cfg; monitor.vif = vif;
    if (is_active == UVM_ACTIVE) begin
      driver = ahb_driver::type_id::create("driver", this); driver.cfg = cfg; driver.vif = vif;
      sequencer = ahb_sequencer::type_id::create("sequencer", this); sequencer.cfg = cfg; sequencer.vif = vif;
