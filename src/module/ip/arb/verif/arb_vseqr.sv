...
`ifndef __arb_vseqr__
`define __arb_vseqr__

class arb_vseqr extends uvm_sequencer_base;
  `uvm_component_utils_begin(arb_vseqr)
  `uvm_component_utils_end

  arb_env p_env;

  function new(string name = "arb_vseqr", uvm_component parent = null);
