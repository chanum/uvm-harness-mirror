...
class cpu_env extends uvm_env;
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    if (cfg.role != BLIND) begin
      if (! uvm_config_db#(cpu_pharness_base)::get(this, "", "harness", harness)) begin
        `uvm_fatal("build_phase", "No cpu_pharness_base 'harness' in uvm_config_db")
      end
