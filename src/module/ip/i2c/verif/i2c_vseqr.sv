...
`ifndef __i2c_vseqr__
`define __i2c_vseqr__

class i2c_vseqr extends uvm_sequencer_base;
  `uvm_component_utils_begin(i2c_vseqr)
  `uvm_component_utils_end

  i2c_env p_env;

  function new(string name = "i2c_vseqr", uvm_component parent = null);
