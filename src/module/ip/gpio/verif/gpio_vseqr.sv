...
`ifndef __gpio_vseqr__
`define __gpio_vseqr__

class gpio_vseqr extends uvm_sequencer_base;
  `uvm_component_utils_begin(gpio_vseqr)
  `uvm_component_utils_end

  gpio_env p_env;

  function new(string name = "gpio_vseqr", uvm_component parent = null);
